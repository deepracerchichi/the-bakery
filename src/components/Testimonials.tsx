...
const Testimonials = () => {
  return (
    <section className='px-8 py-10'>
        <div className='bg-brand-maroon rounded-3xl px-8 py-16 md:py-20 flex flex-col items-center'>
            <blockquote className='text-center text-white text-4xl font-bold font-heading max-w-4xl'>
